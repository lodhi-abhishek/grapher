...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "eventHandling": () => (/* binding */ eventHandling),
    ...
    _rendering_js__WEBPACK_IMPORTED_MODULE_0__.canvas.addEventListener("mousemove", function (e) {
        ...
        for (let key in _rendering_js__WEBPACK_IMPORTED_MODULE_0__.view.functions) {
            ...
            if (
                ...
                Math.abs(mousePos(e).y - (0,_rendering_js__WEBPACK_IMPORTED_MODULE_0__.toPixelCoord)(0, y).y) < 50
            ) {
                if (
                    !pointY ||
...
let windowElements = ['x-min', 'x-max', 'y-min', 'y-max', 'x-scale', 'y-scale'];
  for (let i = 0; i < windowElements.length; i++) {
    ...
    (0,_calculate_js__WEBPACK_IMPORTED_MODULE_2__.addCalculateTabListeners)();
...
/* harmony export */   "draw": () => (/* binding */ draw),
/* harmony export */   "findAutoScale": () => (/* binding */ findAutoScale),
...
function render() {
    ...
    (0,_table_js__WEBPACK_IMPORTED_MODULE_2__.renderTable)();
}
